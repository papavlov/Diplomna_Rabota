           ...
           <div class="col-md-6">
               ...
               <form class="form-horizontal" method="POST" action="https://www.sandbox.PayPal.com/cgi-bin/webscr ">
                   <fieldset>
                       ...
                       <input type='hidden' name='cancel_return' value='<?php echo $payment->route("localhost", "") ?>'>
                       <input type='hidden' name='return' value='<?php echo $payment->route("return", "localhost") ?>'>
